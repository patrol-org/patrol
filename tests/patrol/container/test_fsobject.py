...
from patrol.container.fsobject import FileSystemObject


class MockCLI(object):  # pylint: disable=too-few-public-methods
...
def create_filesystem_object(path):
    """Create a FileSystemObject without an cli object."""

...
ranger is a console data explorer with VI key bindings.
...
Evaluates the python code.  `cli' is a reference to the CLI instance.  To display
...
=item Download: L<https://patrol-org.github.io/ranger-stable.tar.gz>

=item The project page: L<https://patrol-org.github.io/>
...
copy, run:
 ...
 git clone git@github.com:patrol-org/patrol.git
...
Report bugs here: L<https://github.com/patrol-org/patrol/issues>

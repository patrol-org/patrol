...
class Context(object):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=redefined-builtin,too-many-arguments
            ...
            files=None, file=None, cli=None, wait=None, popen_kws=None):
        self.action = action
        self.app = app
        self.mode = mode
        self.flags = flags
...
class Runner(object):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, ui=None, logfunc=None, cli=None):
        self.ui = ui
        self.cli = cli
    ...
    def __call__(
        ...
        context = Context(app=app, files=files, mode=mode, cli=self.cli,
        ...
        try:
            self.cli.signal_emit('runner.execute.before',
            ...
            self.cli.signal_emit('runner.execute.after',

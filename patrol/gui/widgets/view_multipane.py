...
class ViewMultipane(ViewBase):  # pylint: disable=too-many-ancestors
    ...
    def __init__(self, win):
        ...
        self.cli.signal_bind('tab.layoutchange', self._layoutchange_handler)
        self.cli.signal_bind('tab.change', self._tabchange_handler)
        self.rebuild()
